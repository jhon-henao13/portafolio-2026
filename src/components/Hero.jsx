    ...
    <section id="inicio" className="relative min-h-screen flex items-center justify-center pt-28 pb-16 overflow-hidden">
      ...
      <div className="container mx-auto px-6 max-w-7xl relative z-10">
        ...
        <div data-aos="fade-up" className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          {/* Columna Principal de Contenido - Expandido a 9 columnas en desktop */}
          <div className="lg:col-span-9 text-center md:text-left space-y-6">
            
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#10D589]/10 border border-[#10D589]/20 text-[#10D589] font-mono text-sm tracking-widest uppercase mb-2 shadow-[0_0_15px_rgba(16,213,137,0.05)]">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-black text-white leading-[1.15] tracking-tight">
              Hola, soy <span className="relative inline-block bg-gradient-to-r from-[#10D589] via-[#26ffb0] to-[#10D589] bg-[length:200%_auto] bg-clip-text text-transparent animate-[shine_5s_linear_infinite] drop-shadow-[0_0_20px_rgba(16,213,137,0.35)] font-extrabold h-20">Estiguar</span>
              <span className="block mt-3 text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-mono text-white/90">
            ...
            {/* Texto de sobre mí optimizado con tipografía premium y mayor presencia */}
            <p id="sobre-mi" style={{ lineHeight: '1.6' }} className="text-slate-200 text-[1.05rem] sm:text-xl md:text-[1.2rem] lg:text-[1.25rem] font-light  text-justify md:text-left max-w-5xl tracking-wide opacity-90 pt-2 selection:bg-[#10D589]/20">
          ...
          {/* Columna Derecha Decorativa de la Rejilla Asimétrica (Ajustada a 3 columnas) */}
          <div className="hidden lg:col-span-3 lg:flex justify-center items-center relative">
